/*
**What is this test?**
This test finds records where a custom course data source is NOT unique on k_course_section. If true,
the grain of dim_course_section could be blown up in a dangerous way, because of the join in the dim_course_section model.

**When is this important to resolve?**
Immediately, if any rows are returned.

**How to resolve?**
Update the model used as a custom data source to ensure it is unique on k_course_section (or make a build model for that purpose).
