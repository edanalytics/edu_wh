...
formatted as (
    select 
        ...
        stg_learning_standards.v_learning_standard_identification_code,
        stg_learning_standards.learning_standard_item_code,
        stg_learning_standards.v_learning_standard_category,
        stg_learning_standards.v_learning_standard_scope,
