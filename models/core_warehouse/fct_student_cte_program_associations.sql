...
{{ cds_depends_on('edu:student_cte_program_associations:custom_data_sources') }}
{% set custom_data_sources = var('edu:student_cte_program_associations:custom_data_sources', []) %}
