...
cumulative_scores as (
    ...
    select
        ...
        -- max_by unsupported in cumulative frames; max gives latest k_objective_assessment seen
        max(annual_scores.k_objective_assessment__latest_year) over (
        ...
        ) as k_objective_assessment__best_year,
