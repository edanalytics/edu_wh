...
formatted as (
    select
        ...
        stage.priority_for_service, 
        stage.last_qualifying_move, 
        stage.us_initial_entry,
        stage.us_most_recent_entry,
        stage.us_initial_school_entry,
        stage.qualifying_arrival_date,
...
{{ add_custom_data_source('edu:student_migrant_education_program_association:custom_data_sources', join_cols=['k_student_program']) }}
